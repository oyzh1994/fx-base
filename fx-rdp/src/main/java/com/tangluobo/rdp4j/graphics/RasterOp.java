...
public class RasterOp {
	 ...
	 */
	public void do_array(int opcode, com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx,
                         int srcy) {
		...
		case 0xf:
			...
			break;
		default:
			JulLog.warn("do_array unsupported opcode: " + opcode);
	 ...
	 */
	public void do_pixel(int opcode, com.tangluobo.rdp4j.graphics.Display dst, int x, int y, int color) {
		...
		case 0xf:
			...
			break;
		default:
			JulLog.warn("do_byte unsupported opcode: " + opcode);
		}
	}

	private void ropAnd(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx, int srcy,
                        int Bpp) {
		// opcode 0x8
		int mask = state.getByteMask();
	...
	private void ropAndInverted(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx,
                                int srcy, int Bpp) {
		// opcode 0x2
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropClear(com.tangluobo.rdp4j.graphics.Display biDst, int width, int x, int y, int cx, int cy, int Bpp) {
	...
	private void ropEquiv(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx, int srcy,
                          int Bpp) {
		// opcode 0x9
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropInvert(com.tangluobo.rdp4j.graphics.Display biDst, int[] dest, int width, int x, int y, int cx, int cy, int Bpp) {
		int mask = state.getByteMask();
		int pdest = (y * width + x);
		for (int i = 0; i < cy; i++) {
			for (int j = 0; j < cx; j++) {
	...
	private void ropNand(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx, int srcy,
                         int Bpp) {
		// opcode 0x7
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropNor(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx, int srcy,
                        int Bpp) {
		// opcode 0x1
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropOr(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx, int srcy,
                       int Bpp) {
		// opcode 0xe
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropOrInverted(com.tangluobo.rdp4j.graphics.Display biDst, int dstwidth, int x, int y, int cx, int cy, int[] src, int srcwidth, int srcx,
                               int srcy, int Bpp) {
		// opcode 0xb
		int mask = state.getByteMask();
		int psrc = (srcy * srcwidth + srcx);
	...
	private void ropSet(com.tangluobo.rdp4j.graphics.Display biDst, int width, int x, int y, int cx, int cy, int Bpp) {
		int mask = state.getByteMask();
		for (int i = x; i < x + cx; i++) {
			for (int j = y; j < y + cy; j++)
