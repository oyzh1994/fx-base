...
public class Packet {
	 ...
	 */
	public int getHeader(int header) throws com.tangluobo.rdp4j.RdesktopException {
		switch (header) {
		...
		case Packet.CHANNEL_HEADER:
			return this.channel;
		default:
			throw new com.tangluobo.rdp4j.RdesktopException("Wrong Header!");
		}
	}
	 ...
	 * @throws com.tangluobo.rdp4j.RdesktopException on error
	 */
	public void pushLayer(int header, int increment) throws com.tangluobo.rdp4j.RdesktopException {
	...
	public void reset(int length) {
		// JulLog.info("RdpPacket_Localised.reset(" + length + "), capacity = "
		// + bb.capacity());
		this.end = 0;
		this.start = 0;
	 ...
	 * @throws com.tangluobo.rdp4j.RdesktopException on error
	 */
	public void setHeader(int header) throws com.tangluobo.rdp4j.RdesktopException {
		switch (header) {
		case Packet.MCS_HEADER:
