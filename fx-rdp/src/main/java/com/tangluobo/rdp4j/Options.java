...
import com.tangluobo.rdp4j.CacheBackend;
...
public class Options {
	...
	private com.tangluobo.rdp4j.RdstlsCredentials rdstlsCredentials;
	private List<com.tangluobo.rdp4j.SecurityType> securityTypes = new ArrayList<>(Arrays.asList(com.tangluobo.rdp4j.SecurityType.supported()));
	private int lmCompatibility = 3;
	private com.tangluobo.rdp4j.CredSspTokenMode credSspTokenMode = com.tangluobo.rdp4j.CredSspTokenMode.RAW_NTLM;
	...
	public List<com.tangluobo.rdp4j.SecurityType> getSecurityTypes() {
	...
	public com.tangluobo.rdp4j.RdstlsCredentials getRdstlsCredentials() {
	...
	public int getOsMinor() {
		if (osMinor == -1) {
			if (OSUtil.isWindows95())
				return 0x0002;
			else if (OSUtil.isWindowsNT())
				return 0x0003;
	...
	public com.tangluobo.rdp4j.CredSspTokenMode getCredSspTokenMode() {
