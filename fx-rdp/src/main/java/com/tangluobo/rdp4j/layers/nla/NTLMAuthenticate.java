...
public class NTLMAuthenticate implements com.tangluobo.rdp4j.layers.nla.PacketPayload {
	...
	public NTLMAuthenticate(com.tangluobo.rdp4j.layers.nla.NTLMState state) throws IOException, RdesktopCryptoException {
		this.state = state;
		/*
