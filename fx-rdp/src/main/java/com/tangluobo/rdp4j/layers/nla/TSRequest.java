...
public class TSRequest implements BerPayload {
	...
	public BerType write() throws IOException {
		...
		if (negoData != null) {
			...
			JulLog.info(String.format("Added SPNEGO structure"));
		...
		if (authInfo != null) {
			 ...
			 */
			JulLog.info(String.format("Added TSCredentials structure"));
		 ...
		 */
		if (pubKeyAuth != null) {
			JulLog.info(String.format("Added pubkeyAuth structure"));
		 ...
		 */
		if (errorCode != null) {
			JulLog.info(String.format("Added errorCode structure"));
