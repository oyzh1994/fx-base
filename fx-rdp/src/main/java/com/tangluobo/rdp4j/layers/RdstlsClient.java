...
final class RdstlsClient {
    ...
    private final com.tangluobo.rdp4j.layers.Transport transport;
    ...
    void start() throws IOException, RdesktopException {
        ...
        out.write(request);
        out.flush();
        JulLog.info("RDSTLS v1 authentication request sent ({} bytes)", request.length);
        ...
        JulLog.info("RDSTLS v1 redirected-session authentication completed");
    }
