...
//
//public class VncImageView extends ImageView implements BiConsumer<ServerDecoderEvent, ImageRect>, Destroyable {
//
...
//        try {
//            if (vncImage == null) {
//                JulLog.error("canvas image has not been initialized");
//                return;
//            }
...
//                case CURSOR:
//                    if (!useClientCursor) {
//                        JulLog.warn("ignore cursor encoding");
//                        return;
//                    }
...
//                    break;
//                default:
//                    JulLog.error("not supported encoding rect: {}", rect);
//                    break;
//            }
//        } catch (Exception e) {
//            JulLog.error("rect: " + String.valueOf(rect), e);
//        } finally {
//            rect.release();
//        }
//    }
...
//            this.pointerHandler.setZoomLevel(zoomLevel);
//        }
//    }
//
