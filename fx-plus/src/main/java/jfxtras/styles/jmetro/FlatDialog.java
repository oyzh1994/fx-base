package jfxtras.styles.jmetro;// package jfxtras.styles.jmetro;
//
...
//         Image whiteIcon = new Image(JMetro.class.getResource("/jmetro/image/whiteIcon.png").toExternalForm());
