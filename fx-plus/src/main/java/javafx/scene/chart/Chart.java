...
public abstract class Chart extends Region {
    ...
    public final Node getLegend() { return legend.getValue(); }
    public final void setLegend(Node value) { legend.setValue(value); }
    public final ObjectProperty<Node> legendProperty() { return legend; }
