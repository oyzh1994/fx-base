...
// * @since 2022/5/31
// */
//public class SVGGlyph3 extends Region implements NodeGroup, NodeAdapter, ThemeAdapter, MouseAdapter, TipAdapter, StateAdapter {
//
//    {
...
//    }
//
//    public SVGGlyph3(@NonNull String url) {
//        this();
//        this.setUrl(url);
//    }
//
//    public SVGGlyph3(@NonNull String url, @NonNull Paint color) {
//        this();
//        this.setUrl(url);
//        this.setColor(color);
//    }
//
//    public SVGGlyph3(@NonNull String url, @NonNull String size) {
//        this();
//        this.setUrl(url);
//        this.setSizeStr(size);
//    }
//
//    public SVGGlyph3(@NonNull String url, double size) {
//        this();
//        this.setUrl(url);
//        this.setSize(size);
//    }
...
//
//    @Override
//    public SVGGlyph3 clone() {
//        SVGGlyph3 glyph = new SVGGlyph3(this.url, this.color);
