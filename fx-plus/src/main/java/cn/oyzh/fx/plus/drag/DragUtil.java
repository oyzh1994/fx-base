...
public class DragUtil {
    ...
    public static void clearDragFile(Scene scene) {
        if (PropertiesUtil.has(scene, DragFileHandler.DRAG_FILE_HANDLER_KEY)) {
            DragFileHandler handler = (DragFileHandler) PropertiesUtil.get(scene, DragFileHandler.DRAG_FILE_HANDLER_KEY);
