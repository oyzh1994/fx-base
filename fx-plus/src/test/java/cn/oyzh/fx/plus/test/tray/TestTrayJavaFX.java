...
class TestTrayJavaFX {
    ...
    public static final URL BLUE_CAMPING = TestTrayJavaFX.class.getResource("/tray/accommodation_camping.glow.0092DA.32.png");
    public static final URL BLACK_FIRE = TestTrayJavaFX.class.getResource("/tray/amenity_firestation.p.000000.32.png");

    public static final URL BLACK_MAIL = TestTrayJavaFX.class.getResource("/tray/amenity_post_box.p.000000.32.png");
    public static final URL GREEN_MAIL = TestTrayJavaFX.class.getResource("/tray/amenity_post_box.p.39AC39.32.png");

    public static final URL BLACK_BUS = TestTrayJavaFX.class.getResource("/tray/transport_bus_station.p.000000.32.png");
    public static final URL LT_GRAY_BUS = TestTrayJavaFX.class.getResource("/tray/transport_bus_station.p.999999.32.png");

    public static final URL BLACK_TRAIN = TestTrayJavaFX.class.getResource("/tray/transport_train_station.p.000000.32.png");
    public static final URL GREEN_TRAIN = TestTrayJavaFX.class.getResource("/tray/transport_train_station.p.39AC39.32.png");
    public static final URL LT_GRAY_TRAIN = TestTrayJavaFX.class.getResource("/tray/transport_train_station.p.666666.32.png");

    // from issue 123
    public static final URL NOTIFY_IMAGE = TestTrayJavaFX.class.getResource("/tray/RemoteNotifications.png");
