...
// * The following example creates an editable control with the default {@link FXRichTextArea}:
...
//     */
//    public FXRichTextArea(RichTextModel model) {
//        super(model);
//    }
//
//    /**
...
//        if ((m != null) && (!(m instanceof RichTextModel))) {
...
//        return new FXRichTextAreaSkin(this);
//    }
//
//    /**
...
//
//                @Override
//                public CssMetaData<FXRichTextArea, Font> getCssMetaData() {
...
//
//                @Override
//                public CssMetaData<FXRichTextArea, Number> getCssMetaData() {
//                    return FXRichTextArea.StyleableProperties.LINE_SPACING;
//                }
//            };
//        }
//        return lineSpacing;
...
//        private static final CssMetaData<FXRichTextArea,Number> LINE_SPACING =
//                new CssMetaData<>("-fx-line-spacing", SizeConverter.getInstance(), 0) {
//
//                    @Override public boolean isSettable(FXRichTextArea n) {
//                        return n.lineSpacing == null || !n.lineSpacing.isBound();
//                    }
//
//                    @Override public StyleableProperty<Number> getStyleableProperty(FXRichTextArea n) {
//                        return (StyleableProperty<Number>)n.lineSpacingProperty();
//                    }
//                };
//
//        private static final FontCssMetaData<FXRichTextArea> FONT =
//                new FontCssMetaData<>("-fx-font", defaultFont())
//                {
//                    @Override
//                    public boolean isSettable(FXRichTextArea n) {
//                        return n.font == null || !n.font.isBound();
//                    }
//
//                    @Override
//                    public StyleableProperty<Font> getStyleableProperty(FXRichTextArea n) {
//                        return (StyleableProperty<Font>)(WritableValue<Font>)n.fontProperty();
//                    }
//                };
//
//        private static final CssMetaData<FXRichTextArea, Number> TAB_SIZE =
...
//
//                    @Override
//                    public StyleableProperty<Number> getStyleableProperty(FXRichTextArea n) {
...
//        return FXRichTextArea.StyleableProperties.STYLEABLES;
//    }
//
//    @Override
